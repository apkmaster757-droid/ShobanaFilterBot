...
# Yeh automatic background server Render ko continuous "Alive" report bhejta rahega
def run_port_server():
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002490892111').split()]
...
# ✨ Yahan Script.py ka naya bina links wala caption load hoga
