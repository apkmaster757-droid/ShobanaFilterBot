...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                return await query.answer('Dashboard Menu')
        ...
        return await query.answer('Systems Online')
        ...
        return await query.answer('Connection Deleted')
        ...
        if groupids is None:
            ...
            return await query.answer('Main Menu')
        buttons = []
    ...
    if query.data.startswith("file"):
        ...
        # 🚫 FORCE CLEAN CAPTION OVERWRITE (Purane Malayalam/Spam links ko yahi block kar diya)
        ...
        # 🚫 FORCE CLEAN CAPTION FOR FORCE-SUB USERS TOO
        f_caption = f"📂 <b>Filename:</b> <code>{title}</code>\n♻️ <b>FileSize:</b> <code>{size}</code>\n\n⚠️ <i>This file will be deleted automatically according to channel settings. Please forward it to your Saved Messages to keep it.</i>"
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Mᴀɴᴜᴀʟ Fɪʟᴛᴇ r', callback_data='manuelfilter'),
